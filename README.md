...
When changing CSS, JavaScript, manifest, or icons, keep cache-busting query strings aligned. The current expected asset version is `8.9.0`, and the static asset test validates that version alignment.
